[color-pallete.html](https://github.com/user-attachments/files/24110475/color-pallete.html)# CarterBroadhead.github.io[color-pallete.css](https://github.com/user-attachments/files/24110474/color-pallete.css)
/* Input note styling */
.input-note {
	text-align: center;
	font-size: 0.95rem;
...
.color-count-input {
	width: 120px;
	padding: 10px;[Uploading color-pallete
  
  <!DOCTYPE html>
<html lang="en">
<head>[color-pallete.js](https://github.com/user-attachments/files/24110477/color-pallete.js)
